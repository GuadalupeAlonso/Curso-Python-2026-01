...
#! los diccionarios son estructuras de datos que permiten almacenar una colección de elementos no ordenados,
#! mutables y accesibles mediante claves.
#? los diccionarios se definen utilizando llaves {} y los elementos se almacenan en pares clave-valor separados por dos puntos (:).
#? cada clave en un diccionario debe ser única e inmutable (como cadenas, números o tuplas)
