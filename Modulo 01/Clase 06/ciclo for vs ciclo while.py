...
#la diferencia entre un ciclo for y un ciclo while es que el ciclo for itera sobre una secuencia (como una lista, tupla, diccionario, conjunto o cadena)
...
#! cuando no se sabe cuántas veces se repetirá el bloque de código y depende de una condición.
print("-"*30)
